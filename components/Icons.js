...
export default function Icons() {
  return (
    <div className="flex items-center justify-center w-full mt-5 text-center">
      <Link href="https://www.instagram.com/taichi_tomi/" target="_blank">
        <a className="mr-3 text-gray-300 hover:text-pink-500">
          <FaInstagramSquare className="w-7 h-7" />
        </a>
      </Link>
      <Link href="https://github.com/taichi-de" target="_blank">
        <a className="mr-3 text-gray-300 hover:text-gray-600">
